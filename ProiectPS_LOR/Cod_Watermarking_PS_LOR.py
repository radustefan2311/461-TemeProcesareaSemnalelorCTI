...
def main():
    ...
    color_image = Image.open('test.jpg') #incarcam imaginea originala si o transformam in grayscale, iar "test.jpg" este imaginea peste care aplicam watermark-ul
    ...
    if choice == '1': #aici este procesata optiunea aleasa de catre utilizator privind tehnica de aplicare a watermark-ului
        ...
        image_path = "test.jpg" #pentru optiunea 2, LSB Watermarking, se aplica watermark-ul folosind tehnica LSB
        watermark_path = "test2.jpg" #urmand, dupa salvarea rezultatului inserarii watermark-ului peste imaginea originala, extragerea acestuia
    ...
    output_path = "result_image.jpg" #se salveaza imaginea cu acest nume si se afiseaza calea
    ...
    if choice == '2': #aici utilizatorul este intrebat daca vrea sa extraga watermark-ul din imagine
        if input("Extract watermark? (y/n): ").lower() == 'y':
            ...
            watermarked_image_path = "result_image.jpg"
